...
const corsOptions = {
  origin: process.env.CORS_ORIGIN || ['https://salestracker.github.io', 'http://localhost:3000'],
  credentials: true,
...
app.listen(port, () => {
  ...
  console.log(`CORS configured for origin: ${Array.isArray(corsOptions.origin) ? corsOptions.origin.join(', ') : corsOptions.origin}`);
});